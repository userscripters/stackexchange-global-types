export type BasicPlacement = "auto" | "top" | "right" | "bottom" | "left";
// Minimum TypeScript Version: 4.1
export type AllPlacements =
    | BasicPlacement
 ...
 */
export function toggleModal(element: HTMLElement, show?: boolean): void;
...
export interface GetPopoverResult {
 ...
 * @param element the element the `data-controller="s-popover"` attribute is on
 */
export function hidePopover(element: Element): void;
/**
 ...
 */
export function detachPopover(element: Element): GetPopoverResult["popover"];
/**
 ...
 */
export function getPopover(element: Element): GetPopoverResult;
/**
